const CACHE_NAME = 'arabrus-cache-v31';
const APP_SHELL = [
  './',
  './index.html',
  './offline.html',
...
async function injectClientScripts(response) {
  ...
  const injectBlock = '<script src="/tts-enhancer.js"></script><script src="/offline-notes.js"></script><script src="/access-date-helper.js"></script><script src="/access-sync.js"></script><script src="/us-history-reading.js"></script><script src="/us-history-reading-fix.js"></script><script src="/us-history-reading-v2.js"></script>';
